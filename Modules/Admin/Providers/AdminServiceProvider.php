...
class AdminServiceProvider extends ServiceProvider
{
    ...
    /**
     * THis is the sentinel guard and it provides us the facility
     * to use larvel helper function such as : auth()->user() , auth()->id() etc
     *
     * @return void
     */
    public function registerSentinelGuard(){
