...
class ProductBrand extends Model
{
    ...
    public function getActionsAttribute(){
        ...
        if (Sentinel::hasAccess('edit-product-brand')){
            $actions_html .= modal_anchor(
                route('admin.products-brand.edit', ['products-brand' => $this->id]),
        ...
        if (Sentinel::hasAccess('delete-product-brand')) {
    ...
    public function products(){
        return $this->hasMany('Modules\Admin\Entities\Product', 'product_brand_id');
    }
