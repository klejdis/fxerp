{!! Form::model($productCategory, ['route' => ['admin.products-category.update' , $productCategory ], 'method' => 'post', 'class'=> 'general-form', 'id' => 'update-product-category-form']) !!}
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#update-product-category-form').appForm({
