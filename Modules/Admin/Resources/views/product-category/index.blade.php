        ...
        <div class="panel panel-default">
            <div class="page-title clearfix">
                ...
                <div class="title-button-group">
                    {!! modal_anchor(route('admin.products-category.quick_create') ,__('admin::admin.Create Category') , ['class' => 'btn btn-default']) !!}
                </div>
            </div>
...
@push('scripts')
    <script>
        $(document).ready(function () {
            ...
            $('#table').appTable({
                source :  '{{ route('admin.products-category.datatable') }}',
                columns : [
                    {  title : 'Id' , data : 'id'},
