{!! Form::model($role, ['route' => ['admin.roles.update' , $role ], 'method' => 'post', 'class'=> 'general-form', 'id' => 'update-role-form']) !!}
...
<div class="modal-body">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-8">
            {!! Form::text('slug' , null , ['class' => 'form-control', 'data-rule-required' => 1 ])   !!}
        </div>
    </div>
